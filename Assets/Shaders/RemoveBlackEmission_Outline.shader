Shader "Custom/RemoveBlackEmission_Outline"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Devuelve el alpha "visible" de un sample segun la logica de este shader
            half SampleAlpha(float2 uv)
            {
                ...
                return smoothstep(_Threshold, _Threshold + _Softness, lum) * t.a;
            }
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half  alpha = smoothstep(_Threshold, _Threshold + _Softness, lum) * tex.a;
                ...
                half3 emission = _EmissionColor.rgb * _EmissionIntensity * lum;
                color += emission;
