...
namespace OutlineFx
{
    public partial class OutlineFxFeature : ScriptableRendererFeature
    {
        ...
        private static readonly HashSet<Outline> _registered = new HashSet<Outline>();
        private static readonly List<Outline> _renderers = new List<Outline>();

        public static void Register(Outline inst)
        {
            if (inst != null) _registered.Add(inst);
        }

        public static void Unregister(Outline inst)
        {
            if (inst != null) _registered.Remove(inst);
        }
